        ...
        <main className="flex-1 flex items-center justify-center text-center px-4 py-16 sm:px-6 lg:px-8">
            <div className="max-w-lg w-full flex flex-col items-center gap-8">
                ...
                <div className="flex flex-col gap-4">
                    <h1 className="text-4xl font-bold tracking-tighter">Unespexcepted Error</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm">
                    <button className="flex-1 flex items-center justify-center gap-2 rounded-lg h-12 px-6 text-base font-bold bg-primary text-white hover:bg-primary/90 transition-colors"
                        onClick={() => navigate('/')}>
