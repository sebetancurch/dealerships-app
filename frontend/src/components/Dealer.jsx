                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="mb-8 space-y-2 text-gray-600 dark:text-gray-400">
                                <div className="flex items-center">
                                    ...
                                    <p className="ml-2 text-base text-gray-700 dark:text-gray-300"><span className="text-gray-500 dark:text-gray-400">{reviewsCount === 1 ? "1 Review" : `${reviewsCount} Reviews`}</span></p>
                                </div>
                                <p>{dealer.address}</p>
                            </div>
