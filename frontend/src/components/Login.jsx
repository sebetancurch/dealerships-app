      ...
      <div className="w-full max-w-md space-y-8 bg-background-light dark:bg-background-dark p-10 rounded-xl border border-border-light dark:border-border-dark">
        ...
        <form onSubmit={login_} className="mt-8 space-y-6" method="POST">
          ...
          <div className="rounded-lg shadow-sm -space-y-px">
            <div>
              <label className="sr-only" htmlFor="username-address">
                Username
              </label>
              <input
                autoComplete="username"
                className="appearance-none rounded-t-lg relative block w-full px-3 py-4 border border-border-light dark:border-border-dark placeholder-subtle-light dark:placeholder-subtle-dark text-text-light dark:text-text-dark bg-background-light dark:bg-background-dark focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
                id="username-address"
                name="username"
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-b-lg relative block w-full px-3 py-4 border border-border-light dark:border-border-dark placeholder-subtle-light dark:placeholder-subtle-dark text-text-light dark:text-text-dark bg-background-light dark:bg-background-dark focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
                id="password"
                name="password"
          ...
          <div>
            <button
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-bold rounded-lg text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-background-light dark:focus:ring-offset-background-dark"
              type="submit"
            >
              Sign In
            </button>
